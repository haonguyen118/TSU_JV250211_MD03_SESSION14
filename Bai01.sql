...
select orders.order_id,orders.customer_id, orders.order_date, orders.total_amount, orders.status
 from orders
 left join customers on orders.customer_id = customers.customer_id;
 
 select	customers.customer_id, customers.name, customers.phone, orders.order_id, orders.status from orders 
 right join customers on orders.customer_id = customers.customer_id;
 
 select customers.customer_id, customers.name, orders.order_id, orders.total_amount, orders.order_date
